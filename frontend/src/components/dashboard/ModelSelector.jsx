  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        disabled={isLoading}
        className="flex items-center space-x-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              ...
              {models.map((model) => (
                ...
                >
                  <div className={`mt-0.5 p-1.5 rounded-md ${
                    model.provider === 'groq' ? 'bg-orange-100 text-orange-600' : 'bg-blue-100 text-blue-600'
                  }`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <span className={`text-sm font-medium ${
                        selectedModelId === model.model_id ? 'text-indigo-700' : 'text-gray-900'
                      }`}>
                        {model.name}
                      </span>
                    ...
                    <div className="flex items-center mt-0.5 space-x-2">
                       ...
                       {!model.supports_tools && (
                         <span className="flex items-center text-[10px] text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded border border-amber-100" title="This model does not support tools and may perform poorly with RAG">
